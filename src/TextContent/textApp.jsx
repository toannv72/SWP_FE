...
export const textApp = {
  ...
  Invoice: {
    ...
    thankyou:
      "Cảm ơn quý khách đã sử dụng dịch vụ. Đơn hàng sẽ được chúng tôi chuẩn bị và giao đến trong thời gian sớm nhất. Chúng tôi hy vọng quý khách hài lòng với dịch vụ.",
    ...
    payPalMethod: "Hình thức thanh toán: Đã thanh toán bằng Paypal",
