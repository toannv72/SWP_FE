...
export default function TableUser() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <div>
          <div className="flex justify-center text-lg text-cyan-600">
            hoạt động
          </div>
        </div>
      ),
  ...
  return (
    <>
      ...
      <ComSideNav/>
      <div className="flex p-5 justify-center ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen bg-gray-50 transition-all duration-200">
        <Table
          rowKey="_id"
          columns={columns}
          dataSource={products}
