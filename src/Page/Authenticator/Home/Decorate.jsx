  ...
  const fetchData = async (pageNumber) => {
    try {
      const response = await getData(
        `/artwork?page=${pageNumber}&limit=20&cate=Trang trí`
      );
      const newArray =
...
console.log(products);
  ...
  return (
    <>
      ...
      <ComPost />
      <h1 className="px-10 text-slate-900 text-2xl tracking-tight font-extrabold sm:text-3xl dark:text-white">Thể loại:Trang trí </h1>
